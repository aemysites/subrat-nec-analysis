...
## Environments
- Preview: https://main--subrat-nec-analysis--aemysites.aem.page/
- Live: https://main--subrat-nec-analysis--aemysites.aem.live/
- Block Library: https://main--subrat-nec-analysis--aemysites.aem.page/tools/sidekick/library.html?plugin=blocks
...
1. Open the `subrat-nec-analysis` directory in your favorite IDE and start coding :)
